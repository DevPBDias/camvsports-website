...
export function CTAButton({
  ...
  const baseStyles =
    "hover:scale-105 cursor-pointer group gap-3 min-w-48 lg:min-w-64 2xl:min-w-80 inline-flex items-center justify-center rounded-xl px-6 py-3 text-sm text-white shadow-lg transition hover:translate-y-px";
